...
* **Current Goal**: Finish the read-only Feature 08 mandatory LLM query-planning and hybrid retrieval slice, then implement Feature 09 search-run/evidence persistence.
